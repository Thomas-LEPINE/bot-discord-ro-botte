...
module.exports.run = async (client, message, args) => {
    ...
    var group_name;
    if (Object.keys(args).length < 1) { // Si la commande a des arguments
    ...
    message.channel.send(`📢 **S'inscrire à l'un des groupes à l'aide des réactions**\n⚠️ (Maximum de 10 groupes) : _${nb_group}_ groupes\n__Chef de groupe:__ @\`${message.author.tag}\` ID\`${message.author.id}\``).then(async msg => {
